    ...
    <div>
        ...
        <form method="post">
            <div class="container">
                ...
                <h3>입력한 비번 : {{passwd}}</h3>
                <div id='example-3'> 취미
                    <input type="checkbox" id="java" value="Java" v-model="checkedHobbies">
                    <label for="java">Java</label>
                    <input type="checkbox" id="javascript" value="Javascript" v-model="checkedHobbies">
                    <label for="javascript">Javascript</label>
                    <input type="checkbox" id="sql" value="SQL" v-model="checkedHobbies">
                    <label for="sql">SQL</label>
                    <br>
                    <span>체크한 이름: {{ checkedHobbies}}</span>
                </div>
